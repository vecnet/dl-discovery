module Blacklight::FacetsHelperBehavior
  ...
  def render_facet_value(facet_solr_field, item, options ={})
    ...
    content_tag(:span, :class => "facet-label") do
      link_to_unless(options[:suppress_link], facet_display_value(facet_solr_field, item), path, :data=> {:'facet-name' => facet_solr_field, :'facet-solr-value' => item.value}, :class=>"facet_select")
